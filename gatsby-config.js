const config = {
  ...
  shortTitle: 'FM Interactive pricing component',
  // Project description. Used in SEO meta tag and by PWA
  description: 'My solution for Frontend Mentor "Interactive pricing component" challenge',
  ...
  baseUrl: 'https://p1t1ch-fm-interactive-pricing-component.netlify.app',
